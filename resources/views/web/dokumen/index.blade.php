            ...
            <div class="card">
              ...
              <div class="card-body">
                <p class="card-text text-capitalize">
                 Mekanisme penetapan komisaris dan direksi mengacu pada peraturan menteri dalam negeri no 37 tahun 2018 tentang pengangkatan dan pemberhentian anggota dewan pengawas atau anggota komisaris dan anggota direksi badan usaha milik daerah.
                </p>
                <a href="{{ asset('assets/documents/Permendagri-Nomor-37-Tahun-2018.pdf') }}" target="_blank" class="btn btn-primary">Lihat dokumen</a>
              </div>
            </div>
          </div>
          <div class="col-12 col-md-4">
            <div class="card">
              ...
              <div class="card-body">
                ...
                <a href="{{ asset('assets/documents/sop-pelayanan-informasi-publik.pdf') }}" target="_blank" class="btn btn-primary">Lihat dokumen</a>
              </div>
            </div>
          </div>
          <div class="col-12 col-md-4">
            <div class="card">
              ...
              <div class="card-body">
                <p class="card-text text-capitalize">
                 LAPORAN TAHUNAN PT TBJ TAHUN 2024
                </p>
                <a href="{{ asset('assets/documents/Laporan Tahunan Pt. Tbj thn 2024.pdf') }}" target="_blank" class="btn btn-primary">Lihat dokumen</a>
              </div>
            </div>
          </div>
          <div class="col-12 col-md-4">
